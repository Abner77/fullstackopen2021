...
const errorHandler = (error, request, response, next) => {
    ...
    console.error("error en errorhandler " + error.message)
    console.log("error en errorhandler " + error.name)
...
app.put('/api/persons/:id', (request, response, next) => {
    ...
    Person.findById(request.params.id).then(person => {
                if (person)
                {
                    ...
                    person.save().then(valor => {
                                    console.log("ha grabado el muy hijo puta")
                                    response.json(person)
                                    })
                                .catch(error => {
